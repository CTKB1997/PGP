...
namespace AppTest.Key
{
    public class PGPDecrypt
    {
       ...
       */
        ...
        public static Stream Decrypt(string input, string privateKeyFile, string passPhrase)
        {
            if (!File.Exists(input))
                throw new FileNotFoundException(String.Format("Encrypted File [{0}] not found.", input));
            ...
            using (Stream inputStream = File.OpenRead(input))
            {
                ...
                {
                    return Decrypt(inputStream, keyIn, passPhrase);
                }
            }
        }
        ...
        */
        ...
        public static Stream Decrypt(Stream inputStream, Stream privateKeyStream, string passPhrase)
        {
            try
            {
